...
export class AddBaseEntities1695239291072 implements MigrationInterface {
  name = 'AddBaseEntities1695239291072';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "media_to_albums" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "albumId" uuid, "mediaId" uuid, CONSTRAINT "PK_ff258968f0e53dd4285d991e6b6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "media_to_albums" ADD CONSTRAINT "FK_7af7e0b190f7e432d6e9bc3b314" FOREIGN KEY ("albumId") REFERENCES "album"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "media_to_albums" ADD CONSTRAINT "FK_fc982e6f321af4586d3f7aff460" FOREIGN KEY ("mediaId") REFERENCES "media"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
