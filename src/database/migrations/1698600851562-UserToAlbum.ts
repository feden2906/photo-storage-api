...
export class UserToAlbum1698600851562 implements MigrationInterface {
  name = 'UserToAlbum1698600851562';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_to_album_role_enum" AS ENUM('Owner', 'Editor', 'Viewer')`,
    );
    await queryRunner.query(
